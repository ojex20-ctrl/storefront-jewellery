  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-20 md:px-12 md:py-32">
      <Reveal>
        ...
        <h1 className="mb-12 font-display text-5xl leading-tight tracking-tight md:text-7xl">
          We&apos;re here to help.
        </h1>
          ...
          <div>
            ...
            <div className="grid gap-6">
              <div>
                ...
                <p className="font-display text-xl">hello@syrathelabel.com</p>
              </div>
              <div>
                <h3 className="mb-1 font-mono text-[10px] uppercase tracking-widest text-muted">WhatsApp</h3>
                <p className="font-display text-xl">+91 98765 43210</p>
              </div>
            </div>
          </div>
